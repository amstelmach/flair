import ovalblue from '../images/OvalBlue.jpg'
        ...
        <div style={{width: '410px', minHeight: '297px', backgroundColor: '#203C86', borderRadius: '5px', color: '#ffffff', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{display: 'flex', flexDirection: 'column', marginLeft: '29px', marginTop: '15px', marginBottom: '15px', justifyContent: 'center'}}>
                <div style={{display: 'flex', alignItems: 'center', marginBottom: '9px'}}>
                    <img alt='icon' style={{width: '24px', height: '25px', marginRight: '12px'}} src={ovalblue} ></img><span>Hiring and Onboarding</span>
                </div>
                <div style={{display: 'flex', alignItems: 'center', marginBottom: '9px'}}>
                    <img alt='icon' style={{width: '24px', height: '25px', marginRight: '12px'}} src={ovalblue} ></img><span>Employee database</span>
                </div>
                <div style={{display: 'flex', alignItems: 'center', marginBottom: '9px'}}>
                    <img alt='icon' style={{width: '24px', height: '25px', marginRight: '12px'}} src={ovalblue} ></img><span>Document management</span>
                </div>
                    
                <div style={{display: 'flex', alignItems: 'center'}}>
                    <img alt='icon' style={{width: '24px', height: '25px', marginRight: '12px'}} src={ovalblue} ></img><span>Reporting</span>
                </div>
            </div>
